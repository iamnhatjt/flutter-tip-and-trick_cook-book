...
class ChainAnimationExample extends StatefulWidget {
  const ChainAnimationExample({Key? key}) : super(key: key);

  @override
  State<ChainAnimationExample> createState() => _ChainAnimationExampleState();
}
...
class _ChainAnimationExampleState extends State<ChainAnimationExample>
